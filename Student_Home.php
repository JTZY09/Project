...
<body>
    ...
    <h1><?php echo _WELCOME_TO_THE_STUDENT_PORTAL; ?>, <?php echo $username; ?></h1>
        ...
        <div class="image-container">
            <div>
                <a href="Student_Class.php">
                    ...
                    <div class="image-text">Click to mark attendance</div>
                </a>
            </div>
            <div>
                <a href="Student_Results.php">
                    <img src="Result.png" alt="Result">
                    <div class="image-text">Click to view results</div>
                </a>
            </div>
        </div>
    </div>
